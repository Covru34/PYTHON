print("--- Робота зі списками в Python ---")
...
# можна звертати до елементів списку за індексу
...
print("myList після додавання списку котів:", cats)

del myList[0] # видяляємо перший елемент списку
print("myList псля видалення першого елемента:", myList)
